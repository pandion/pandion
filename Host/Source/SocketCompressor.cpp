 ...
 * Constructor
 */
SocketCompressor::SocketCompressor()
{
	Reset();
}
...
/*
 * This method is called when the socket wants to notify this object that a
 * connection has been established.
 */
void SocketCompressor::OnConnected()
{
	Reset();
...
/*
 * This method is called when the socket wants to notify this object that it's
 * connection was terminated.
 */
void SocketCompressor::OnDisconnected()
{
	Reset();
 ...
 */
std::vector<BYTE> SocketCompressor::Decompress(std::vector<BYTE>& data)
{
 ...
 */
bool SocketCompressor::Select(bool read, bool write)
{
