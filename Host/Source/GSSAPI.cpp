...
STDMETHODIMP GSSAPI::GenerateResponse(BSTR Challenge, BOOL *Continue, BSTR *Response)
{
...
void GSSAPI::Error(LPWSTR Where, LPWSTR WhenCalling, LPWSTR ErrorMessage)
{
	std::wostringstream dbgMsg;
	dbgMsg << L"GSSAPI error in " << Where <<" when calling " << WhenCalling <<
