function dial_file ( Address )
{
	...
	{
		setTitle( external.globals( 'Translator' ).Translate( 'main', 'wnd_file_send', [ external.globals( 'ClientRoster' ).Items.Exists( ShortAddress ) ? external.globals( 'ClientRoster' ).Items.Item( ShortAddress ).Name : ShortAddress ] ) );
