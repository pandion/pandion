function XMPPOnConnected ()
{
	...
	var Str = '<stream:stream to="' + external.globals( 'cfg' ).Item( 'server' ) + '" xml:lang="' + external.globals( 'language' ) + '" xmlns="jabber:client" xmlns:stream="http://etherx.jabber.org/streams" version="1.0">';
	warn( 'SENT: ' + Str );
	external.XMPP.SendText( Str );
}
